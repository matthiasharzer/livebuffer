...
| GET    | `/api/v1/live`                                                         | Streams the currently live stream if available (restream). If no stream is live, a 404 response will be returned.                                                                                                                                                                                                                                                                                                                                                                                    |
| GET    | `/`                                                                    | Show the UI, which currently embeds the live stream from the `/api/v1/live` endpoint, if available.                                                                                                                                                                                                                                                                                                                                                                                                  |
