...
| `--public-url`      | ✅       |                       | The public base URL for the REST API. Used for Twitch EventSub Webhook notifications, which require a public accesible URL. This is usually the endpoint for your reverse proxy which forwards requests to the REST API.  |
